...
export default function DeleteChoferes(props: Acoplados) {
    ...
    const borrarAcoplado = () => {
        fetch(`${backendURL}/choferes/${cuil}`, {
            method: "DELETE",
            headers: {
            ...
            .then((_data) => {
                const newChofer = choferes.filter(
                    (chofer: { cuil: any }) => chofer.cuil !== cuil
                );
                setChoferes(newChofer);
            })
            .catch((error) => {
        ...
        <>
            ...
            >
                <Typography variant="h6" color="textPrimary" align="center">
                    ¿Está seguro de que quiere eliminar el Chofer?
                </Typography>
                <ClearSharpIcon
