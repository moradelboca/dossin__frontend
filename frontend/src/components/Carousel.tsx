...
const sxStyles: SxProps<Theme> = {
  ...
  height: "100%", // Ajustar para que tome la altura del contenedor padre
  minHeight: "400px", // Define una altura mínima para evitar cortes en el contenido
  maxHeight: "auto", // Ajuste flexible

  [`& .${carouselClasses.content}`]: {
    width: "100%",
    display: "flex",
    alignItems: "center",
    height: "100%", // Hacer que el contenido ocupe el 100% del contenedor
  },
  ...
  [`& .${carouselClasses.list}`]: {
    ...
    [`& .${carouselClasses.item}`]: {
      ...
      boxSizing: "border-box",
      height: "100%", // Asignar el 100% de la altura a los elementos de la lista
      "&:last-child": {
        marginRight: 0,
      },
      ...
      [`&.${carouselClasses.center}`]: {
        // Opcionalmente, puedes aplicar una escala o transformar elementos centrados
      },
    },
  },
