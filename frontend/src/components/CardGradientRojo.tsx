...
export function TarjetaChoferesInconveniente(props: TarjetaProps) {
        ...
        <StyledRoot>
          <StyledContent gradientColor={confirmado ? "#76D766" : "#A5A5A5"}>
            <Box position={"relative"} zIndex={1}>
              ...
              <TypographySubtitle>Inconveniente:</TypographySubtitle>
              <TypographySubtitle>{textInconveniente}</TypographySubtitle>
